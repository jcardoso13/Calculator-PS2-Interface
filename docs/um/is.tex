...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=.8\textwidth]{instr_rd}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=.8\textwidth]{rw_rd}}
    \vspace{0cm}\caption{Control Bus interface reads.}
    \label{fig:rwird}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=.8\textwidth]{rw_wr}}
